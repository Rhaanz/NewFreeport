...
RULE_INT(Character, Hastev3Cap, 999, "Haste cap for v3(over haste) haste")
...
RULE_REAL(Spells, DotRatio, 0.000, "Dot Dmg Ratio 1 = true 1.5 = 150% .5 = 50% spelldmg")
RULE_REAL(Spells, HealRatio, 0.000, "Heal Dmg Ratio 1 = true 1.5 = 150% .5 = 50% healamt")
RULE_REAL(Spells, HotRatio, 0.000, "HoT Dmg Ratio 1 = true 1.5 = 150% .5 = 50% healamt")
RULE_REAL(Spells, SpellRatio, 0.000, "Spell Dmg Ratio 1 = true 1.5 = 150% .5 = 50% spelldmg")
